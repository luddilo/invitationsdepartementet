...
/* Generator docs: https://packagist.org/packages/mitulgolakiya/laravel-api-generator
    php artisan mitul.generator:api Post --fromTable --tableName=posts --skipMigration */
...
return [
    ...
    */
    ...
    'path_routes'              => base_path('routes/web.php'),

    'path_api_routes'          => base_path('routes/api.php'),
